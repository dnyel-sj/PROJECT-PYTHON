...
def get_weather():
    try: 
        ...
        # Weather
        api_key ="3de83e15f775f2800091b2bcf22c6f4f"
...
# Clock
clock_label = tk.Label(root, font=("Helvetica", 20, "bold"), fg="#4b4bcc")
...
wind_label = tk.Label(root, text="", font=("arial", 20, "bold"),
                        bg="#1ab5ef", fg="#404040")
wind_label.place(x=110, y=430)

humidity_label = tk.Label(root, text="", font=("arial", 20, "bold"),
                        bg="#1ab5ef", fg="#404040")
humidity_label.place(x=310, y=430)
...
pressure_label = tk.Label(root, text="", font=("arial", 20, "bold"),
                        bg="#1ab5ef", fg="#404040")
pressure_label.place(x=700, y=430)
